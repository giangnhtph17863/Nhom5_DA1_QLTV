...
public class JFrmThemPhieuMuon extends javax.swing.JFrame {
   ...
   private final  IKhachHangService _iKhachHangService;
    ...
    public JFrmThemPhieuMuon() {
     ...
     _iPhieuMuonService = new PhieuMuonService();
        ...
        List<NhanVienModel> nhanViens = _iNhanVienService.getQuanLyNV(PROPERTIES, SOMEBITS);
        List<KhachHangModels> khachHangs = _iKhachHangService.getKhachHang();
        initComponents();
   ...
   private void loadTable(){
    ...
    private PhieuMuonModel getPhieuMuonFromInput() {
        ...
        NhanVien nv = _iNhanVienService.getNvByMaNV(txtMaNV.getText());
        model.setMaNV(nv);
        KhachHang kh = _iKhachHangService.getKhachHangByID(txtMaKH.getText());
        model.setMaKH(kh);
