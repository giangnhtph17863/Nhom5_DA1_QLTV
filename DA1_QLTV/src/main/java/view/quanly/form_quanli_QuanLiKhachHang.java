...
import services.IManageQuanLiKhachHangService;
import Model.QLKhachHang;
import Entities.NhanVien;
import helper.XCheck;
import helper.XMgsbox;
import javax.swing.JOptionPane;
import services.ManageQuanLiKhachHangService;
import services.IManageQuanLiKhachHangService;
public class form_quanli_QuanLiKhachHang extends javax.swing.JFrame {
DefaultTableModel defaultTableModel;
    private final IManageQuanLiKhachHangService _iManageQuanLiKhachHangService;
int index;
    ...
    public form_quanli_QuanLiKhachHang() {
        ...
        _iManageQuanLiKhachHangService = new ManageQuanLiKhachHangService();
...
txtEmail.setText(tblQlkh.getModel().getValueAt(index,0).toString());
txtMakh.setText(tblQlkh.getModel().getValueAt(index,1).toString());
txtTenKh.setText(tblQlkh.getModel().getValueAt(index,2).toString());
txtDiaChi.setText(tblQlkh.getModel().getValueAt(index,3).toString());
txtMatKhau.setText(tblQlkh.getModel().getValueAt(index,4).toString());
txtManv.setText(tblQlkh.getModel().getValueAt(index,5).toString());
txtNgaySinh.setText(tblQlkh.getModel().getValueAt(index,6).toString());
txtSdt.setText(tblQlkh.getModel().getValueAt(index,7).toString());
